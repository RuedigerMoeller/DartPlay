...
RLTable: {"": "Object;selectedRowId,table,tableHeader,rowIdCnt,headerRenderer,rowRenderer,defValRend,renderStyle,pane,headerPane,selectedRows,rows,singleSel,upDown,upArrow,doArrow",
  scrollVisible$1: function(cur) {
    ...
    if (t3 < t4) {
      ...
      t2 = J.get$top$x(t2.getBoundingClientRect());
      if (typeof t1 !== "number")
        throw t1.$sub();
      if (typeof t2 !== "number")
        throw H.iae(t2);
      if (typeof t4 !== "number")
        throw t4.$sub();
      t3.scrollTop = C.JSNumber_methods.toInt$0(t4 - (t1 - t2) - 4);
    } else {
      t3 = J.get$top$x(t2.getBoundingClientRect());
      t4 = t2.offsetHeight;
      if (typeof t3 !== "number")
      ...
      if (t3 + t4 > t5 + t6 - 16) {
        ...
        if (typeof t2 !== "number")
          throw H.iae(t2);
        t3.scrollTop = C.JSNumber_methods.toInt$0(4 + t4 - (t5 + t1 - 16 - (t6 + t2)));
      }
    }
  },
  ...
  setHeader$1: function(header) {
    var newRow;
    if (J.get$length$asx(J.get$rows$x(this.tableHeader)) === 0)
      J.addRow$0$x(this.tableHeader);
    newRow = J.$index$asx(J.get$rows$x(this.tableHeader), 0);
    J.get$attributes$x(newRow)._element.setAttribute("t_id", "header");
    this.headerRenderer.renderRow$4("header", newRow, header, this.renderStyle);
    this.adjustColWidthFromHeader$0();
  },
  adjustColWidthFromHeader$0: function() {
    var t1, hd, bd, t2, t3, t4, t5;
    t1 = {};
    if (J.get$length$asx(J.get$rows$x(this.tableHeader)) < 1 || J.get$length$asx(J.get$rows$x(this.table)) < 1)
      return;
    hd = J.get$cells$x(J.$index$asx(J.get$rows$x(this.tableHeader), 0));
    bd = J.get$cells$x(J.$index$asx(J.get$rows$x(this.table), 0));
    if (hd._list.length < 1 || bd._list.length < 1)
      return;
    t1.index_0 = 0;
    t1.prevBody_1 = null;
    t1.prevHeader_2 = null;
    hd.forEach$1(hd, new N.RLTable_adjustColWidthFromHeader_closure(t1, bd));
    t2 = t1.prevHeader_2;
    if (t2 != null) {
      t2 = J.get$marginEdge$x(t2);
      t3 = t2._element.offsetWidth;
      t2 = t2._addOrSubtractToBoxModel$2($.get$_WIDTH(), "margin");
      if (typeof t3 !== "number")
        throw t3.$add();
      t4 = t1.prevBody_1;
      t4.toString;
      t4 = new W._MarginCssRect(t4, 0, 0, 0, 0);
      t5 = t4._element.offsetWidth;
      t4 = t4._addOrSubtractToBoxModel$2($.get$_WIDTH(), "margin");
      if (typeof t5 !== "number")
        throw t5.$add();
      if (t3 + t2 - 4 < t5 + t4) {
        t2 = J.get$contentEdge$x(t1.prevHeader_2);
        t1 = t1.prevBody_1;
        t1.toString;
        t1 = new W._ContentCssRect(t1, 0, 0, 0, 0);
        t3 = t1._element.offsetWidth;
        t1 = t1._addOrSubtractToBoxModel$2($.get$_WIDTH(), "content");
        if (typeof t3 !== "number")
          throw t3.$add();
        t2.set$width(t2, t3 + t1 + 4);
      }
    }
  },
  setHeaderSortArrow$2: function(field, up) {
    var t1 = J.get$cells$x(J.$index$asx(J.get$rows$x(this.tableHeader), 0));
    t1.forEach$1(t1, new N.RLTable_setHeaderSortArrow_closure(this, field, up));
  },
  updateRow$2: function(rowId, newValues) {
    var t1, data;
    t1 = this.rows;
    data = t1.$index(t1, rowId);
    if (data != null) {
      newValues.forEach$1(newValues, new N.RLTable_updateRow_closure(data));
      t1 = J.get$cells$x(this.findRow$1(rowId));
      t1.forEach$1(t1, new N.RLTable_updateRow_closure0(this, newValues));
      this.adjustColWidthFromHeader$0();
    }
  },
  addRowWithId$2: function(id, data) {
    var newRow, t1;
    newRow = J.addRow$0$x(this.table);
    newRow.toString;
    new W._ElementAttributeMap(newRow)._element.setAttribute("t_id", id);
    t1 = this.rows;
    t1.$indexSet(t1, id, data);
    this.rowRenderer.renderRow$4(id, newRow, data, this.renderStyle);
    this.adjustColWidthFromHeader$0();
  },
  addRowAsMap$1: function(data) {
    ...
    new W._ElementAttributeMap(newRow)._element.setAttribute("t_id", id);
    t1 = this.rows;
    t1.$indexSet(t1, id, new N.RowMapAdapter(data, H.Primitives_parseInt(id, null, null)));
    this.rowRenderer.renderRow$4(id, newRow, t1.$index(t1, id), this.renderStyle);
    this.adjustColWidthFromHeader$0();
  },
  sort$2: function(_, field, up) {
    var t1, list;
    t1 = J.map$1$ax(J.get$rows$x(this.table), new N.RLTable_sort_closure(this));
    list = t1.toList$1$growable(t1, false);
    H.IterableMixinWorkaround_sortList(list, new N.RLTable_sort_closure0(field, up));
    H.IterableMixinWorkaround_forEach(J.toList$1$growable$ax(J.get$rows$x(this.table), false), new N.RLTable_sort_closure1());
    t1 = this.rows;
    t1.clear$0(t1);
    H.IterableMixinWorkaround_forEach(list, new N.RLTable_sort_closure2(this));
    this.setHeaderSortArrow$2(field, up);
  },
  RLTable$1: function(id) {
    var t1, t2, t3;
    this.renderStyle = new N.DefaultRenderSpec(this.defValRend);
    this.table = document.querySelector(id);
    t1 = id + "-pane";
    this.pane = document.querySelector(t1);
    t1 = id + "-header-pane";
    this.headerPane = document.querySelector(t1);
    t1 = id + "-header";
    this.tableHeader = document.querySelector(t1);
    ...
    t2 = this.pane;
    t2.toString;
    t2 = new W._ElementEventStreamImpl(t2, C.EventStreamProvider_scroll._eventType, false);
    ...
    H.setRuntimeTypeInfo(t1, [null]);
    t3 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new N.RLTable_closure1(this)), t1._useCapture);
    ...
    H.setRuntimeTypeInfo(t2, [null]);
    t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new N.RLTable_closure2(this)), t2._useCapture);
    H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t3._tryResume$0();
    t3 = this.table;
    t3.toString;
    t3 = new W._ElementEventStreamImpl(t3, C.EventStreamProvider_dblclick._eventType, false);
    H.setRuntimeTypeInfo(t3, [null]);
    t2 = new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new N.RLTable_closure3(this)), t3._useCapture);
    ...
    H.setRuntimeTypeInfo(t2, [null]);
    t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new N.RLTable_closure4(this)), t2._useCapture);
    H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t3._tryResume$0();
  },
  static: {
...
RLTable$: function(id) {
  var t1 = new N.RLTable("-1", null, null, 1, new N.RLTableHeaderRowRenderer("#008DCC", "#00C3FF"), new N.RLTableRowRenderer(), new N.RLValueRenderer(), null, null, null, P.LinkedHashMap_LinkedHashMap(null, null, null, null, null), P.LinkedHashMap_LinkedHashMap(null, null, null, null, null), true, true, " <span class=\"arrow-n\"></span>", " <span class=\"arrow-s\"></span>");
  t1.RLTable$1(id);
  return t1;
}}
...
RLTable_closure: {"": "Closure;this_0",
  call$1: function(ev) {
    this.this_0.adjustColWidthFromHeader$0();
  },
  $is_args1: true
},
...
RLTable_closure0: {"": "Closure;this_1",
  call$1: function($event) {
    var t1 = this.this_1;
    t1.headerPane.scrollLeft = t1.pane.scrollLeft;
  },
  $is_args1: true
},

RLTable_closure1: {"": "Closure;this_2",
  call$1: function($E) {
    var t1 = this.this_2;
    t1.sort$2(t1, J.get$attributes$x(J.get$target$x($E))._element.getAttribute("t_field"), t1.upDown);
    t1.upDown = !t1.upDown;
  },
  $is_args1: true
},

RLTable_closure2: {"": "Closure;this_3",
  call$1: function($event) {
...
RLTable_closure3: {"": "Closure;this_4",
  call$1: function($event) {
    this.this_4.updateRow$2(J.get$attributes$x(J.get$target$x($event))._element.getAttribute("t_id"), H.fillLiteralMap(["Qty", "99", "Price", "2.01"], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)));
  },
  $is_args1: true
},

RLTable_closure4: {"": "Closure;this_5",
  call$1: function($event) {
...
RLTable_adjustColWidthFromHeader_closure: {"": "Closure;box_0,bd_1",
  call$1: function(headCell) {
    var t1, t2, t3, bodyCell, offR, offH, t4, t5, t6;
    t1 = this.box_0;
    t2 = t1.index_0;
    t3 = this.bd_1._list;
    if (t2 < 0 || t2 >= t3.length)
      throw H.ioore(t3, t2);
    bodyCell = t3[t2];
    offR = J.get$offset$x(bodyCell);
    offH = J.get$offset$x(headCell);
    t2 = t1.prevHeader_2;
    if (t2 != null) {
      t3 = offR.left;
      t4 = offH.get$left(offH);
      if (typeof t3 !== "number")
        throw t3.$lt();
      if (typeof t4 !== "number")
        throw H.iae(t4);
      if (t3 < t4) {
        t2 = t1.prevBody_1;
        t2.toString;
        t2 = new W._ContentCssRect(t2, 0, 0, 0, 0);
        t4 = t2._element.offsetWidth;
        t5 = t2._addOrSubtractToBoxModel$2($.get$_WIDTH(), "content");
        if (typeof t4 !== "number")
          throw t4.$add();
        t6 = offH.left;
        if (typeof t6 !== "number")
          throw t6.$sub();
        t2.set$width(t2, t4 + t5 + (t6 - t3));
      } else {
        t4 = offH.left;
        if (typeof t4 !== "number")
          throw t4.$lt();
        if (t4 < t3) {
          t2 = J.get$contentEdge$x(t2);
          t5 = t2._element.offsetWidth;
          t6 = t2._addOrSubtractToBoxModel$2($.get$_WIDTH(), "content");
          if (typeof t5 !== "number")
            throw t5.$add();
          t2.set$width(t2, t5 + t6 + (t3 - t4));
        }
      }
    }
    t1.prevHeader_2 = headCell;
    t1.prevBody_1 = bodyCell;
    t1.index_0 = t1.index_0 + 1;
  },
  $is_args1: true
},

RLTable_setHeaderSortArrow_closure: {"": "Closure;this_0,field_1,up_2",
  call$1: function(cell) {
    var t1, t2, t3, t4, t5;
    t1 = J.getInterceptor$x(cell);
    t2 = this.this_0;
    t3 = t2.upArrow;
    if (J.endsWith$1$s(t1.get$innerHtml(cell), t3))
      t1.set$innerHtml(cell, J.substring$2$s(t1.get$innerHtml(cell), 0, t1.get$innerHtml(cell).length - t3.length));
    t2 = t2.doArrow;
    if (J.endsWith$1$s(t1.get$innerHtml(cell), t2))
      t1.set$innerHtml(cell, J.substring$2$s(t1.get$innerHtml(cell), 0, t1.get$innerHtml(cell).length - t2.length));
    t4 = t1.get$attributes(cell)._element.getAttribute("t_field");
    t5 = this.field_1;
    if (t4 == null ? t5 == null : t4 === t5) {
      t4 = t1.get$innerHtml(cell);
      t1.set$innerHtml(cell, J.$add$ns(t4, this.up_2 ? t3 : t2));
    }
  },
  $is_args1: true
},

RLTable_updateRow_closure: {"": "Closure;data_0",
  call$2: function(key, val) {
    return this.data_0.setValue$2(key, val);
  },
  $is_args2: true
},

RLTable_updateRow_closure0: {"": "Closure;this_1,newValues_2",
  call$1: function(cell) {
    var t1, field, t2;
    t1 = J.getInterceptor$x(cell);
    field = t1.get$attributes(cell)._element.getAttribute("t_field");
    t2 = this.newValues_2;
    if (t2.$index(t2, field) != null) {
      t1.set$innerHtml(cell, this.this_1.defValRend.renderValue$2(cell, t2.$index(t2, field)));
      J.set$backgroundColor$x(cell.style, "#db0");
      P.Timer_Timer(P.Duration$(0, 0, 0, 1000, 0, 0), new N.RLTable_updateRow__closure(cell));
    }
  },
  $is_args1: true
},

RLTable_updateRow__closure: {"": "Closure;cell_3",
  call$0: function() {
    var t1 = this.cell_3;
    J.set$transition$x(t1.style, "background-color 1s");
    J.set$backgroundColor$x(t1.style, "");
    P.Timer_Timer(P.Duration$(0, 0, 0, 1050, 0, 0), new N.RLTable_updateRow___closure(t1));
  }
},

RLTable_updateRow___closure: {"": "Closure;cell_4",
  call$0: function() {
    J.set$transition$x(this.cell_4.style, "");
  }
},

RLTable_sort_closure: {"": "Closure;this_0",
  call$1: function(row) {
    var t1 = this.this_0.rows;
    return t1.$index(t1, J.get$attributes$x(row)._element.getAttribute("t_id"));
  },
  $is_args1: true
},

RLTable_sort_closure0: {"": "Closure;field_1,up_2",
  call$2: function(idA, idB) {
    var t1 = this.field_1;
    t1 = J.compareTo$1$ns(idA.getValue$1(t1), idB.getValue$1(t1));
    return t1 * (this.up_2 ? -1 : 1);
  },
  $is_args2: true
},

RLTable_sort_closure1: {"": "Closure;",
  call$1: function(row) {
    J.remove$0$ax(row);
  },
  $is_args1: true
...
RLTable_sort_closure2: {"": "Closure;this_3",
  call$1: function(rowData) {
    this.this_3.addRowWithId$2(H.S(rowData.getId$0()), rowData);
  },
  $is_args1: true
},
...
ListRowMapAdapter: {"": "RLTableRowData;data",
  getFieldNames$0: function() {
    return this.data;
  },
  getValue$1: function(fieldName) {
    return fieldName;
  },
  setValue$2: function(fieldName, value) {
    return;
  },
  getId$0: function() {
    return -1;
...
RowMapAdapter: {"": "RLTableRowData;data,rowId",
  getFieldNames$0: function() {
    return P.List_List$from(this.data.get$keys(), true, null);
  },
  getValue$1: function(fieldName) {
    var t1 = this.data;
    return t1.$index(t1, fieldName);
  },
  setValue$2: function(fieldName, value) {
    var t1 = this.data;
    t1.$indexSet(t1, fieldName, value);
    return value;
  },
  getId$0: function() {
    return this.rowId;
...
RLValueRenderer: {"": "Object;",
  renderValue$2: function(elem, value) {
    if (typeof value === "number") {
      elem.toString;
      new W._ElementAttributeMap(elem)._element.setAttribute("style", "text-align:right;");
      if (typeof value === "number" && Math.floor(value) === value)
        return C.JSInt_methods.toString$0(C.JSInt_methods.toInt$0(value));
      else
        return C.JSNumber_methods.toStringAsFixed$1(value, 2);
    }
    return H.S(value);
  }
},

RLTableHeaderRowRenderer: {"": "RLTableRowRenderer;headerBG,headerBGHover",
  renderRow$4: function(rowId, target, row, style) {
    H.IterableMixinWorkaround_forEach(row.getFieldNames$0(), new N.RLTableHeaderRowRenderer_renderRow_closure(this, rowId, target, row, style));
  }
},

RLTableHeaderRowRenderer_renderRow_closure: {"": "Closure;this_0,rowId_1,target_2,row_3,style_4",
  call$1: function(f) {
    var cell, val, t1, t2, t3;
    cell = J.addCell$0$x(this.target_2);
    val = this.style_4.defValRend.renderValue$2(cell, f);
    cell.toString;
    new W._ElementAttributeMap(cell)._element.setAttribute("t_field", f);
    new W._ElementAttributeMap(cell)._element.setAttribute("t_id", this.rowId_1);
    new W._ElementAttributeMap(cell)._element.setAttribute("nowrap", "nowrap");
    t1 = this.this_0;
    new W._ElementAttributeMap(cell)._element.setAttribute("style", "text-align:center;background-color: " + t1.headerBG + ";");
    J.set$transition$x(cell.style, "background-color .3s");
    J.setInnerHtml$1$x(cell, val);
    t2 = new W._ElementEventStreamImpl(cell, C.EventStreamProvider_mouseenter._eventType, false);
    H.setRuntimeTypeInfo(t2, [null]);
    t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new N.RLTableHeaderRowRenderer_renderRow__closure(t1, cell)), t2._useCapture);
    H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t3._tryResume$0();
    t3 = new W._ElementEventStreamImpl(cell, C.EventStreamProvider_mouseleave._eventType, false);
    H.setRuntimeTypeInfo(t3, [null]);
    t1 = new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new N.RLTableHeaderRowRenderer_renderRow__closure0(t1, cell)), t3._useCapture);
    H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t3, "_EventStream", 0)]);
    t1._tryResume$0();
    J.set$paddingBottom$x(cell.style, "6px");
    J.set$paddingTop$x(cell.style, "6px");
  },
  $is_args1: true
},

RLTableHeaderRowRenderer_renderRow__closure: {"": "Closure;this_5,cell_6",
  call$1: function(ev) {
    J.set$background$x(this.cell_6.style, this.this_5.headerBGHover);
  },
  $is_args1: true
},

RLTableHeaderRowRenderer_renderRow__closure0: {"": "Closure;this_7,cell_8",
  call$1: function(ev) {
    J.set$background$x(this.cell_8.style, this.this_7.headerBG);
  },
  $is_args1: true
},
...
RLTableRowRenderer: {"": "Object;",
  renderRow$4: function(rowId, target, row, style) {
    H.IterableMixinWorkaround_forEach(row.getFieldNames$0(), new N.RLTableRowRenderer_renderRow_closure(rowId, target, row, style));
  }
},
...
RLTableRowRenderer_renderRow_closure: {"": "Closure;rowId_0,target_1,row_2,style_3",
  call$1: function(f) {
    var value, cell, val;
    value = this.row_2.getValue$1(f);
    cell = J.addCell$0$x(this.target_1);
    val = this.style_3.defValRend.renderValue$2(cell, value);
    cell.toString;
    new W._ElementAttributeMap(cell)._element.setAttribute("t_field", f);
...
_LinkedHashMap: {"": "Object;_collection$_length,_strings,_nums,_rest,_first,_last,_modifications",
  ...
  get$keys: function() {
    var $arguments, t1, t2;
    $arguments = H.substitute(this.$as_LinkedHashMap, H.getRuntimeTypeInfo(this));
    t1 = $arguments == null ? null : $arguments[0];
    t2 = new P.LinkedHashMapKeyIterable(this);
...
TextAreaElement: {"": "HtmlElement;name=,rows=,value=", "%": "HTMLTextAreaElement"},
...
_ContentCssRect: {"": "CssRect;_element,left,top,width,height",
  get$height: function(_) {
    var t1, t2;
    t1 = this._element.offsetHeight;
  ...
  set$width: function(_, newWidth) {
    var t1;
    if (typeof newWidth === "object" && newWidth !== null && !!C.JSNumber_methods.$isDimension) {
      t1 = C.JSNumber_methods.get$value(newWidth);
      t1.$lt(t1, 0);
      J.set$width$x(this._element.style, H.S(newWidth._value) + newWidth._unit);
    } else {
      if (newWidth < 0)
        newWidth = 0;
      J.set$width$x(this._element.style, H.S(newWidth) + "px");
    }
  },
  get$left: function(_) {
    var t1, t2;
...
_MarginCssRect: {"": "CssRect;_element,left,top,width,height",
  get$height: function(_) {
    var t1, t2;
    t1 = this._element.offsetHeight;
...
CssRect: {"": "MutableRectangle;",
  _addOrSubtractToBoxModel$2: function(dimensions, augmentingMeasurement) {
    ...
    for (t1 = new H.ListIterator(dimensions, dimensions.length, 0, null), t2 = augmentingMeasurement === "margin", t3 = !t2, t4 = augmentingMeasurement === "content", val = 0; t1.moveNext$0();) {
      measurement = t1._current;
      if (t2) {
        propValue = styles.getPropertyValue(augmentingMeasurement + "-" + H.S(measurement));
        t5 = W.Dimension$css(propValue != null ? propValue : "")._value;
        if (typeof t5 !== "number")
          throw H.iae(t5);
        val += t5;
      }
...
Dimension: {"": "Object;_value,_unit",
  toString$0: function(_) {
    return H.S(this._value) + this._unit;
  },
  Dimension$css$1: function(cssValue) {
    ...
    t3 = this._unit;
    if (t1)
      this._value = H.Primitives_parseDouble(C.JSString_methods.substring$2(cssValue, 0, t2 - t3.length), null);
    else
      this._value = H.Primitives_parseInt(C.JSString_methods.substring$2(cssValue, 0, t2 - t3.length), null, null);
  },
  $isDimension: true,
  static: {
...
["", "tabletest.dart", , A, {
main: function() {
  var rltable, user, i, t1, t2, mp, $arguments;
  rltable = N.RLTable$("#table_id");
  user = ["Reudi", "Emil", "Felix", "Anita", "Ex*"];
  for (i = 0; i < 100; ++i) {
    t1 = "Dies ist ein text " + i;
    t2 = C.JSInt_methods.$mod(i, 5);
    if (t2 < 0 || t2 >= 5)
      throw H.ioore(user, t2);
    mp = H.fillLiteralMap(["id", i, "text", t1, "Qty", i * 10, "Price", i / 0.34, "User", user[t2], "NotSoShort", ".", "Langtext", "blubb blubb blubb blubb blubb blubb blubb blubb"], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    if (i === 1) {
      t1 = mp.get$keys();
      $arguments = H.substitute(t1.$asIterableBase, H.getRuntimeTypeInfo(t1));
      t2 = $arguments == null ? null : $arguments[0];
      rltable.setHeader$1(new N.ListRowMapAdapter(P.List_List$from(t1, false, t2)));
    }
    rltable.addRowAsMap$1(mp);
  }
  P.Timer_Timer$periodic(P.Duration$(0, 0, 0, 50, 0, 0), new A.main_closure(rltable, C.C__Random));
  P.Timer_Timer$periodic(P.Duration$(0, 0, 0, 50, 0, 0), new A.main_closure0(rltable, C.C__Random));
},

main_closure: {"": "Closure;rltable_0,rnd_1",
  call$1: function(t) {
    var t1 = this.rnd_1;
    this.rltable_0.updateRow$2("" + t1.nextInt$1(100), H.fillLiteralMap(["Qty", t1.nextInt$1(100)], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)));
  },
  $is_args1: true
},

main_closure0: {"": "Closure;rltable_2,rnd_3",
  call$1: function(t) {
    var t1 = this.rnd_3;
    this.rltable_2.updateRow$2("" + t1.nextInt$1(100), H.fillLiteralMap(["Price", t1.nextInt$1(10000) / 100], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)));
  },
  $is_args1: true
}},
1],
...
$.RLTable_selectedStyle = "background-color:#00c0ff;";
...
J.set$paddingBottom$x = function(receiver, value) {
  return J.getInterceptor$x(receiver).set$paddingBottom(receiver, value);
};
...
function dart_precompiled($collectedClasses) {
  ...
  function RLTable(selectedRowId, table, tableHeader, rowIdCnt, headerRenderer, rowRenderer, defValRend, renderStyle, pane, headerPane, selectedRows, rows, singleSel, upDown, upArrow, doArrow) {
    this.selectedRowId = selectedRowId;
    this.table = table;
    this.tableHeader = tableHeader;
    this.rowIdCnt = rowIdCnt;
    this.headerRenderer = headerRenderer;
    this.rowRenderer = rowRenderer;
    this.defValRend = defValRend;
    ...
    this.doArrow = doArrow;
  }
  RLTable.builtin$cls = "RLTable";
  if (!"name" in RLTable)
    RLTable.name = "RLTable";
  $desc = $collectedClasses.RLTable;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTable.prototype = $desc;
  function RLTable_closure(this_0) {
    this.this_0 = this_0;
  }
  RLTable_closure.builtin$cls = "RLTable_closure";
  if (!"name" in RLTable_closure)
    RLTable_closure.name = "RLTable_closure";
  $desc = $collectedClasses.RLTable_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTable_closure.prototype = $desc;
  function RLTable_closure0(this_1) {
    this.this_1 = this_1;
  }
  RLTable_closure0.builtin$cls = "RLTable_closure0";
  if (!"name" in RLTable_closure0)
    RLTable_closure0.name = "RLTable_closure0";
  $desc = $collectedClasses.RLTable_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTable_closure0.prototype = $desc;
  function RLTable_closure1(this_2) {
    this.this_2 = this_2;
  }
  RLTable_closure1.builtin$cls = "RLTable_closure1";
  if (!"name" in RLTable_closure1)
    RLTable_closure1.name = "RLTable_closure1";
  $desc = $collectedClasses.RLTable_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTable_closure1.prototype = $desc;
  function RLTable_closure2(this_3) {
    this.this_3 = this_3;
  }
  RLTable_closure2.builtin$cls = "RLTable_closure2";
  if (!"name" in RLTable_closure2)
    RLTable_closure2.name = "RLTable_closure2";
  $desc = $collectedClasses.RLTable_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTable_closure2.prototype = $desc;
  function RLTable_closure3(this_4) {
    this.this_4 = this_4;
  }
  RLTable_closure3.builtin$cls = "RLTable_closure3";
  if (!"name" in RLTable_closure3)
    RLTable_closure3.name = "RLTable_closure3";
  $desc = $collectedClasses.RLTable_closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTable_closure3.prototype = $desc;
  function RLTable_closure4(this_5) {
    this.this_5 = this_5;
  }
  RLTable_closure4.builtin$cls = "RLTable_closure4";
  if (!"name" in RLTable_closure4)
    RLTable_closure4.name = "RLTable_closure4";
  $desc = $collectedClasses.RLTable_closure4;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTable_closure4.prototype = $desc;
  function RLTable_clearSelection_closure(this_0) {
    this.this_0 = this_0;
  }
  RLTable_clearSelection_closure.builtin$cls = "RLTable_clearSelection_closure";
  if (!"name" in RLTable_clearSelection_closure)
    RLTable_clearSelection_closure.name = "RLTable_clearSelection_closure";
  $desc = $collectedClasses.RLTable_clearSelection_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTable_clearSelection_closure.prototype = $desc;
  function RLTable_adjustColWidthFromHeader_closure(box_0, bd_1) {
    this.box_0 = box_0;
    this.bd_1 = bd_1;
  }
  RLTable_adjustColWidthFromHeader_closure.builtin$cls = "RLTable_adjustColWidthFromHeader_closure";
  if (!"name" in RLTable_adjustColWidthFromHeader_closure)
    RLTable_adjustColWidthFromHeader_closure.name = "RLTable_adjustColWidthFromHeader_closure";
  $desc = $collectedClasses.RLTable_adjustColWidthFromHeader_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTable_adjustColWidthFromHeader_closure.prototype = $desc;
  function RLTable_setHeaderSortArrow_closure(this_0, field_1, up_2) {
    this.this_0 = this_0;
    this.field_1 = field_1;
    this.up_2 = up_2;
  }
  RLTable_setHeaderSortArrow_closure.builtin$cls = "RLTable_setHeaderSortArrow_closure";
  if (!"name" in RLTable_setHeaderSortArrow_closure)
    RLTable_setHeaderSortArrow_closure.name = "RLTable_setHeaderSortArrow_closure";
  $desc = $collectedClasses.RLTable_setHeaderSortArrow_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTable_setHeaderSortArrow_closure.prototype = $desc;
  function RLTable_updateRow_closure(data_0) {
    this.data_0 = data_0;
  }
  RLTable_updateRow_closure.builtin$cls = "RLTable_updateRow_closure";
  if (!"name" in RLTable_updateRow_closure)
    RLTable_updateRow_closure.name = "RLTable_updateRow_closure";
  $desc = $collectedClasses.RLTable_updateRow_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTable_updateRow_closure.prototype = $desc;
  function RLTable_updateRow_closure0(this_1, newValues_2) {
    this.this_1 = this_1;
    this.newValues_2 = newValues_2;
  }
  RLTable_updateRow_closure0.builtin$cls = "RLTable_updateRow_closure0";
  if (!"name" in RLTable_updateRow_closure0)
    RLTable_updateRow_closure0.name = "RLTable_updateRow_closure0";
  $desc = $collectedClasses.RLTable_updateRow_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTable_updateRow_closure0.prototype = $desc;
  function RLTable_updateRow__closure(cell_3) {
    this.cell_3 = cell_3;
  }
  RLTable_updateRow__closure.builtin$cls = "RLTable_updateRow__closure";
  if (!"name" in RLTable_updateRow__closure)
    RLTable_updateRow__closure.name = "RLTable_updateRow__closure";
  $desc = $collectedClasses.RLTable_updateRow__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTable_updateRow__closure.prototype = $desc;
  function RLTable_updateRow___closure(cell_4) {
    this.cell_4 = cell_4;
  }
  RLTable_updateRow___closure.builtin$cls = "RLTable_updateRow___closure";
  if (!"name" in RLTable_updateRow___closure)
    RLTable_updateRow___closure.name = "RLTable_updateRow___closure";
  $desc = $collectedClasses.RLTable_updateRow___closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTable_updateRow___closure.prototype = $desc;
  function RLTable_sort_closure(this_0) {
    this.this_0 = this_0;
  }
  RLTable_sort_closure.builtin$cls = "RLTable_sort_closure";
  if (!"name" in RLTable_sort_closure)
    RLTable_sort_closure.name = "RLTable_sort_closure";
  $desc = $collectedClasses.RLTable_sort_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTable_sort_closure.prototype = $desc;
  function RLTable_sort_closure0(field_1, up_2) {
    this.field_1 = field_1;
    this.up_2 = up_2;
  }
  RLTable_sort_closure0.builtin$cls = "RLTable_sort_closure0";
  if (!"name" in RLTable_sort_closure0)
    RLTable_sort_closure0.name = "RLTable_sort_closure0";
  $desc = $collectedClasses.RLTable_sort_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTable_sort_closure0.prototype = $desc;
  function RLTable_sort_closure1() {
  }
  RLTable_sort_closure1.builtin$cls = "RLTable_sort_closure1";
  if (!"name" in RLTable_sort_closure1)
    RLTable_sort_closure1.name = "RLTable_sort_closure1";
  $desc = $collectedClasses.RLTable_sort_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTable_sort_closure1.prototype = $desc;
  function RLTable_sort_closure2(this_3) {
    this.this_3 = this_3;
  }
  RLTable_sort_closure2.builtin$cls = "RLTable_sort_closure2";
  if (!"name" in RLTable_sort_closure2)
    RLTable_sort_closure2.name = "RLTable_sort_closure2";
  $desc = $collectedClasses.RLTable_sort_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTable_sort_closure2.prototype = $desc;
  function RLTableRenderSpec() {
  }
  RLTableRenderSpec.builtin$cls = "RLTableRenderSpec";
  if (!"name" in RLTableRenderSpec)
    RLTableRenderSpec.name = "RLTableRenderSpec";
  $desc = $collectedClasses.RLTableRenderSpec;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTableRenderSpec.prototype = $desc;
  function DefaultRenderSpec(defValRend) {
    this.defValRend = defValRend;
  }
  DefaultRenderSpec.builtin$cls = "DefaultRenderSpec";
  if (!"name" in DefaultRenderSpec)
    DefaultRenderSpec.name = "DefaultRenderSpec";
  $desc = $collectedClasses.DefaultRenderSpec;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DefaultRenderSpec.prototype = $desc;
  function RLTableRowData() {
  }
  RLTableRowData.builtin$cls = "RLTableRowData";
  if (!"name" in RLTableRowData)
    RLTableRowData.name = "RLTableRowData";
  $desc = $collectedClasses.RLTableRowData;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTableRowData.prototype = $desc;
  function ListRowMapAdapter(data) {
    this.data = data;
  }
  ListRowMapAdapter.builtin$cls = "ListRowMapAdapter";
  if (!"name" in ListRowMapAdapter)
    ListRowMapAdapter.name = "ListRowMapAdapter";
  $desc = $collectedClasses.ListRowMapAdapter;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ListRowMapAdapter.prototype = $desc;
  function RowMapAdapter(data, rowId) {
    this.data = data;
    this.rowId = rowId;
  }
  RowMapAdapter.builtin$cls = "RowMapAdapter";
  if (!"name" in RowMapAdapter)
    RowMapAdapter.name = "RowMapAdapter";
  $desc = $collectedClasses.RowMapAdapter;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RowMapAdapter.prototype = $desc;
  function RLValueRenderer() {
  }
  RLValueRenderer.builtin$cls = "RLValueRenderer";
  if (!"name" in RLValueRenderer)
    RLValueRenderer.name = "RLValueRenderer";
  $desc = $collectedClasses.RLValueRenderer;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLValueRenderer.prototype = $desc;
  function RLTableHeaderRowRenderer(headerBG, headerBGHover) {
    this.headerBG = headerBG;
    this.headerBGHover = headerBGHover;
  }
  RLTableHeaderRowRenderer.builtin$cls = "RLTableHeaderRowRenderer";
  if (!"name" in RLTableHeaderRowRenderer)
    RLTableHeaderRowRenderer.name = "RLTableHeaderRowRenderer";
  $desc = $collectedClasses.RLTableHeaderRowRenderer;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTableHeaderRowRenderer.prototype = $desc;
  function RLTableHeaderRowRenderer_renderRow_closure(this_0, rowId_1, target_2, row_3, style_4) {
    this.this_0 = this_0;
    this.rowId_1 = rowId_1;
    this.target_2 = target_2;
    this.row_3 = row_3;
    this.style_4 = style_4;
  }
  RLTableHeaderRowRenderer_renderRow_closure.builtin$cls = "RLTableHeaderRowRenderer_renderRow_closure";
  if (!"name" in RLTableHeaderRowRenderer_renderRow_closure)
    RLTableHeaderRowRenderer_renderRow_closure.name = "RLTableHeaderRowRenderer_renderRow_closure";
  $desc = $collectedClasses.RLTableHeaderRowRenderer_renderRow_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTableHeaderRowRenderer_renderRow_closure.prototype = $desc;
  function RLTableHeaderRowRenderer_renderRow__closure(this_5, cell_6) {
    this.this_5 = this_5;
    this.cell_6 = cell_6;
  }
  RLTableHeaderRowRenderer_renderRow__closure.builtin$cls = "RLTableHeaderRowRenderer_renderRow__closure";
  if (!"name" in RLTableHeaderRowRenderer_renderRow__closure)
    RLTableHeaderRowRenderer_renderRow__closure.name = "RLTableHeaderRowRenderer_renderRow__closure";
  $desc = $collectedClasses.RLTableHeaderRowRenderer_renderRow__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTableHeaderRowRenderer_renderRow__closure.prototype = $desc;
  function RLTableHeaderRowRenderer_renderRow__closure0(this_7, cell_8) {
    this.this_7 = this_7;
    this.cell_8 = cell_8;
  }
  RLTableHeaderRowRenderer_renderRow__closure0.builtin$cls = "RLTableHeaderRowRenderer_renderRow__closure0";
  if (!"name" in RLTableHeaderRowRenderer_renderRow__closure0)
    RLTableHeaderRowRenderer_renderRow__closure0.name = "RLTableHeaderRowRenderer_renderRow__closure0";
  $desc = $collectedClasses.RLTableHeaderRowRenderer_renderRow__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTableHeaderRowRenderer_renderRow__closure0.prototype = $desc;
  function RLTableRowRenderer() {
  }
  RLTableRowRenderer.builtin$cls = "RLTableRowRenderer";
  if (!"name" in RLTableRowRenderer)
    RLTableRowRenderer.name = "RLTableRowRenderer";
  $desc = $collectedClasses.RLTableRowRenderer;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTableRowRenderer.prototype = $desc;
  function RLTableRowRenderer_renderRow_closure(rowId_0, target_1, row_2, style_3) {
    this.rowId_0 = rowId_0;
    this.target_1 = target_1;
    this.row_2 = row_2;
    this.style_3 = style_3;
  }
  RLTableRowRenderer_renderRow_closure.builtin$cls = "RLTableRowRenderer_renderRow_closure";
  if (!"name" in RLTableRowRenderer_renderRow_closure)
    RLTableRowRenderer_renderRow_closure.name = "RLTableRowRenderer_renderRow_closure";
  $desc = $collectedClasses.RLTableRowRenderer_renderRow_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RLTableRowRenderer_renderRow_closure.prototype = $desc;
  ...
  function MappedIterator(_current, _dev$_iterator, _f) {
    this._current = _current;
    this._dev$_iterator = _dev$_iterator;
    this._f = _f;
  }
  ...
  function WhereIterator(_dev$_iterator, _f) {
    this._dev$_iterator = _dev$_iterator;
    this._f = _f;
  }
  ...
  function Dimension(_value, _unit) {
    this._value = _value;
    this._unit = _unit;
  }
  ...
  function main_closure(rltable_0, rnd_1) {
    this.rltable_0 = rltable_0;
    this.rnd_1 = rnd_1;
  }
  ...
  function main_closure0(rltable_2, rnd_3) {
    this.rltable_2 = rltable_2;
    this.rnd_3 = rnd_3;
  }
